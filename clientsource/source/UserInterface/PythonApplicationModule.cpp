...
#if defined(__BL_MIDDLE_BOARD_WINDOW__)
	PyModule_AddIntConstant(poModule, "__BL_MIDDLE_BOARD_WINDOW__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_MIDDLE_BOARD_WINDOW__", false);
#endif

#if defined(__BL_SAVE_CAMERA_MODE__)
	PyModule_AddIntConstant(poModule, "__BL_SAVE_CAMERA_MODE__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_SAVE_CAMERA_MODE__", false);
#endif
...
#if defined(__BL_SMOOTH_SCROLL__)
	PyModule_AddIntConstant(poModule, "__BL_SMOOTH_SCROLL__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_SMOOTH_SCROLL__", false);
#endif
